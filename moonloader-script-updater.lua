...
{
"latest": "17.08.2024",
  "updateurl": "https://github.com/Aodzaki/Admin-Tools/raw/main/AdminTools.lua" 
}
...
return {
    check = function(json_url, prefix, url)
        ...
        if os.clock() - started >= 10 then
            print('v' .. thisScript().version .. ': timeout, âûõîäèì èç îæèäàíèÿ ïðîâåðêè îáíîâëåíèÿ. Ñìèðèòåñü èëè ïðîâåðüòå ñàìîñòîÿòåëüíî íà ' .. url)
        end
    end
}
